...
## Quick status (as of 2026-04-29 evening)

Phase 5e (nas-intake v1) is LIVE on the mini (2026-04-29 23:47): Mac mini
LaunchAgent `com.home-tools.nas-intake` (5-min `StartInterval`) watches
`~/Share1/**/[Ii]ntake/` folders, OCR + classifies via subprocess to
...
## Quick status (as of 2026-04-29)

Phase 5d (NAS mount + LAN recovery) DONE: `/Volumes/Share1` SMB mount lost
after a force-reboot triggered cascading TCC denials, blocking ALL outbound
LAN traffic from the mini. Two GUI toggles fixed it:
