...
ADDRESSES = {
    ...
    # more Mammoth
    "Old New York Deli & Bakery Co.": "6201 Minaret Rd #105, Mammoth Lakes, CA 93546",
    "GOJIRA Ramen & Sushi": "452 Old Mammoth Rd #109, Mammoth Lakes, CA 93546",
    "Giovanni's": "437 Old Mammoth Rd, Mammoth Lakes, CA 93546",
    "Bird and the Biscuit": "26 Old Mammoth Rd Unit L1, Mammoth Lakes, CA 93546",
    "Burgers Restaurant": "6118 Minaret Rd, Mammoth Lakes, CA 93546",
    "Mammoth Rock Brasserie": "3029 Chateau Rd, Mammoth Lakes, CA 93546",
    # June Lake
    "June Lake Brewing": "131 S Crawford Ave, June Lake, CA 93529",
    "Tiger Bar & Cafe": "2620 CA-158, June Lake, CA 93529",
    "T-Bar Social Club": "2588 CA-158, June Lake, CA 93529",
    "Balanced Rock Grill & Cantina": "2588 CA-158, June Lake, CA 93529",
    "Silver Lake Resort Cafe": "6957 CA-158, June Lake, CA 93529",
    "June Lake Junction Cafe & Deli": "June Lake Junction, US-395 & CA-158, June Lake, CA 93529",
    "Eagle's Landing Restaurant": "5587 CA-158, June Lake, CA 93529",
    "June Pie": "2588 CA-158, June Lake, CA 93529",
    # more Bishop
    "Mountain Rambler Brewery": "186 S Main St, Bishop, CA 93514",
    "Black Sheep Coffee Roasters": "232 N Main St, Bishop, CA 93514",
    "Great Basin Bakery": "275 S Main St Ste D, Bishop, CA 93514",
    "Back Alley Bowl and Grill": "649 N Main St, Bishop, CA 93514",
    "Pupfish Cafe": "124 S Main St, Bishop, CA 93514",
    "Astorga's Mexican Restaurant": "Astorga's Mexican Restaurant, Bishop, CA 93514",
}
...
mammoth_rows = [
    ...
    # — more Mammoth Lakes —
    ["Old New York Deli & Bakery Co.", "Mammoth Lakes", "Deli / Bagels", "$$", "Walk-in",
     "(760) 934-3354", "oldnewyork.com",
     "6201 Minaret Rd #105 in The Village — Mammoth's only NY-style deli: real boiled bagels, pastrami, corned beef, matzo ball soup. Daily 6am–4pm. The go-to for grab-and-go trail sandwiches.",
     "❓ Village plaza seating"],
    ["GOJIRA Ramen & Sushi", "Mammoth Lakes", "Japanese / Ramen", "$$", "Walk-in",
     "(760) 965-0080", "gojiramammoth.com",
     "452 Old Mammoth Rd #109 — Godzilla-themed, chef lived 35 yrs in Japan: tonkotsu ramen, rolls, bowls. Hugely popular (2.5k+ Yelp). Daily ~11:30am–8:45pm. Great cold-night post-ride warmer.",
     "❌ Indoor only"],
    ["Giovanni's", "Mammoth Lakes", "Italian / Pizza", "$$", "Walk-in",
     "(760) 934-7563", "giovannismammoth.com",
     "437 Old Mammoth Rd (Minaret Village Center) — 30-yr institution: hand-tossed pizza, chicken parm, casual bar. Daily 11–2 + 5–9. Reliable post-ride family dinner.",
     "❓ Call ahead for patio"],
    ["Bird and the Biscuit", "Mammoth Lakes", "Breakfast / Fast-casual", "$$", "Walk-in",
     "(760) 965-0058", "birdandthebiscuit.com",
     "26 Old Mammoth Rd L1 — scratch biscuits, breakfast sandwiches, biscuits & gravy, fried chicken. Newer local favorite; quick casual morning fuel-up.",
     "❓ Call ahead for patio"],
    ["Burgers Restaurant", "Mammoth Lakes", "American / Burgers", "$$", "Walk-in",
     "(760) 934-6622", "burgersrestaurant.com",
     "6118 Minaret Rd (The Village) — long-running burger joint, big menu, upstairs bar, lively. Lunch + dinner daily. Easy crowd-pleaser after a day on the bikes.",
     "❓ Village plaza seating"],
    ["⭐ Mammoth Rock Brasserie", "Mammoth Lakes", "French / Fine dining", "$$$$",
     "Reservations recommended (OpenTable)", "(760) 934-4200", "mammothrocknbowl.com",
     "SPLURGE alt to Skadi. 3029 Chateau Rd (upstairs at Mammoth Rock 'N' Bowl) — top-rated upscale French/seafood with big valley views. Dinner from 5pm; CLOSED Tue.",
     "❌ Indoor only"],
    # — JUNE LAKE (≈20 min N of Mammoth on the Loop) —
    ["June Lake Brewing", "June Lake", "Brewery", "$$", "Walk-in",
     "(760) 616-4399", "junelakebrewing.com",
     "131 S Crawford Ave, daily noon–8. Small craft brewery ('Super Awesome Beer') with La Parrilla Mexican food truck in the beer garden (~noon–7). Classic post-ride beer stop. NOTE: as of 2026 no longer permitted to allow pets in the beer garden.",
     "❌ No pets (2026)"],
    ["Tiger Bar & Cafe", "June Lake", "Bar & Grill", "$$", "Walk-in",
     "(760) 648-7551", "tigerbarcafe.com",
     "2620 Hwy 158 in the village — 2nd-oldest CA liquor license (est. 1932). Breakfast/lunch/dinner + nightlife, daily 8am–9pm. Big-portion diner-bar fare; reliable any-meal option.",
     "❌ Indoor only"],
    ["T-Bar Social Club", "June Lake", "Bar & Pizza", "$$", "Walk-in",
     "", "tbarjunelake.com",
     "2588 Hwy 158, upstairs in the historic Sierra Inn. Full bar, 6 rotating taps, June Pie NY-style pizza, board games + live music. Back patio with Sierra views welcomes dogs in warmer months.",
     "✅ Dog patio"],
    ["Balanced Rock Grill & Cantina", "June Lake", "Mexican", "$$", "Walk-in",
     "(760) 648-7849", "balancedrockgrill.com",
     "2588 Hwy 158 (same building as T-Bar) — authentic Mexican plates + cocktails. Seasonal summer hours Thu–Sun from 4pm (call to confirm). Big decks with sweeping views.",
     "✅ Deck seating"],
    ["Silver Lake Resort Cafe", "June Lake", "Breakfast / Diner", "$$", "Walk-in (clipboard)",
     "(760) 648-7525", "silverlakeresort.net",
     "6957 Hwy 158, lakeside on the Loop. Cafe 7am–2pm daily (seasonal). Big classic breakfasts + lunch; tiny + beloved, short wait at peak. Scenic Silver Lake setting.",
     "❓ Call ahead"],
    ["June Lake Junction Cafe & Deli", "June Lake", "Coffee / Deli", "$", "Walk-in",
     "", "instagram.com/junelakejunction",
     "Corner of US-395 & CA-158 at the Loop turnoff — coffee, quick breakfast/lunch, deli sandwiches, famously good shakes & malts. Easy grab-and-go fuel on the way to/from a ride.",
     "❓ Call ahead"],
    ["⭐ Eagle's Landing Restaurant", "June Lake", "Fine dining (resort)", "$$$",
     "Reservations recommended (dinner)", "(760) 648-7004", "doubleeagle.com",
     "5587 Hwy 158 at Double Eagle Resort & Spa, daily 7:30am–9pm. The nicest sit-down dinner in the Loop — mountain-view booths, steaks/seafood, Eagles Nest Saloon. The June Lake splurge.",
     "❓ Call ahead"],
    ["June Pie", "June Lake", "Pizza", "$$", "Walk-in / call for pickup",
     "(760) 648-7774", "junelakepizza.com",
     "2588 Hwy 158 (T-Bar building) — NY-style hand-tossed pies, widely rated the Eastern Sierra's best. Call ahead for pickup or eat in downstairs with full-bar service at T-Bar.",
     "✅ Patio (via T-Bar)"],
    # — Bishop —
    ...
    ["Holy Smoke Texas BBQ", "Bishop", "BBQ (Texas-style)", "$$", "Walk-in",
     ...
     "❓ Outdoor (verify)"],
    ["Mountain Rambler Brewery", "Bishop", "Brewery / Patio", "$$", "Walk-in",
     "(760) 258-1348", "mountainramblerbrewery.com",
     "186 S Main St downtown — award-winning craft beer + a real from-scratch food menu (salads, burgers, mains). The go-to Bishop brewpub for a post-ride beer and a proper meal.",
     "✅ Dog patio"],
    ["Black Sheep Coffee Roasters", "Bishop", "Coffee / Cafe", "$", "Walk-in",
     "(760) 872-4142", "blacksheepcoffeeroasters.com",
     "232 N Main St — in-house roaster 20+ yrs: espresso, whole beans, breakfast/light bites. Opens early (~6:30–7am). The serious coffee stop before heading out to ride.",
     "❓ Call ahead"],
    ["Great Basin Bakery", "Bishop", "Bakery / Cafe", "$", "Walk-in",
     "(760) 873-9828", "greatbasinbakerybishop.com",
     "275 S Main St Ste D, daily 7am–4pm — fresh bagels, breads, pastries, deli sandwiches baked daily. The classic trail-lunch / packable-breakfast spot.",
     "❓ Call ahead"],
    ["Back Alley Bowl and Grill", "Bishop", "Steakhouse / Grill", "$$$",
     "Reservations recommended (OpenTable)", "(760) 873-5777", "thebackalleybowlandgrill.com",
     "649 N Main St — signature-rub fire-grilled steaks, burgers, fish; attached bowling alley. ~11am–8:30pm. The most reliable proper sit-down dinner in Bishop.",
     "❌ Indoor only"],
    ["Pupfish Cafe", "Bishop", "Breakfast / Cafe", "$$", "Walk-in",
     "(442) 228-5100", "pupfishcafe.com",
     "124 S Main St, Thu–Tue 8am–2pm (CLOSED Wed) — highly rated creative breakfast + lunch, covered indoor-outdoor patio. Dog policy reported inconsistently — call ahead.",
     "❓ Call ahead"],
    ["Astorga's Mexican Restaurant", "Bishop", "Mexican", "$$", "Walk-in",
     "(760) 872-3849", "instagram.com/astorgasbishop",
     "Family-run sit-down Mexican — generous plates + margaritas. A full-service alternative to the taquerias for a relaxed dinner. Indoor dining.",
     "❌ Indoor only"],
]
...
SECTIONS = [
    ...
    ("MAMMOTH LAKES · JUNE LAKE · BISHOP  |  Aug 14 – 18",   MAM_BG,     mammoth_rows),
]
