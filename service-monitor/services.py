...
SERVICES: list[Svc] = [
    Svc("evt_fetch",    "com.home-tools.event-aggregator.fetch",   "event-aggregator", "every 10 min",
        str(LOG_DIR_HOME_TOOLS / "event-aggregator-fetch.log")),
